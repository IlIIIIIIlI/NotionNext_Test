...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Your CookBook to Become a Pro at Communicating with AI',
  ...
  KEYWORDS:
    ...
    'AI, Prompt Engineering, GPT4, GPTs, ChatGPT, Agent, Midjourney, Runway, Stable Diffusion, Learning Prompt, How to use ChatGPT', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:
    process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'learnprompt2023@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER:
    process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/aiwarts', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/LearnPrompt', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM:
    process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/aiwarts', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI:
    process.env.NEXT_PUBLIC_CONTACT_BILIBILI ||
    'https://space.bilibili.com/1820008345?spm_id_from=333.1007.0.0', // B站主页
  CONTACT_YOUTUBE:
    process.env.NEXT_PUBLIC_CONTACT_YOUTUBE ||
    'https://www.youtube.com/@AiWartsGPT', // Youtube主页
  ...
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-sans font-sans',
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,weibo,email,twitter,telegram,messenger,line,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_BAIDU_ID:
    ...
    '15cfa719c5212aa0ef474deb2e953196', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-LV7H9L9JQ3', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
    ...
    'Your CookBook to Become a Pro at Communicating with AI', // 站点描述，被notion中的页面描述覆盖

...
const CONFIG = {
  ...
  HERO_P_1:
    '🥳 加入我们的免费开源课程，深入了解最先进的AIGC技术，每月为您呈现8个精选热门AI项目🎉',
  ...
  FAQ_RIGHT: [
    {
      ...
      header: '需要人工智能方面的经验吗？',
      subtitle: '不需要！我们的课程将带您了解人工智能的基础知识和高级技巧。'
    },
    {
      icon: (

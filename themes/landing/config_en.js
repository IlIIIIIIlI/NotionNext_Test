...
const CONFIG = {
  ...
  HERO_P_1:
    '🥳 Explore state-of-the-art technology with our free, open-source curriculum, featuring the TOP8 trending projects each month🎉',
  ...
  FEATURES_CARD_1_P:
    'Select your course and embark on your AI journey immediately',
  FEATURES_CARD_2_TITLE: 'Global Network',
  FEATURES_CARD_2_P:
    'Connect with international communities for broad AI skill acknowledgment',
  FEATURES_CARD_3_TITLE: 'Evolving Paths',
  FEATURES_CARD_3_P:
    'Choose from various themes and levels, always freshly updated',
  ...
  POST_REDIRECT_URL:
    process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://www.learnprompt.pro', // 重定向网站地址
